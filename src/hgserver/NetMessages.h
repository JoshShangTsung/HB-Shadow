...
// reversed 3.82+ MSGIDs by Snoopy
...
#define MSGID_REQUEST_SAVEPLAYERDATA_REPLY	0x0DF30770	// �α׼����κ��� ���̺���� ������ �޾ƾ� �ϴ� ��� 
...
//ShortCUt para ballpoints by gigia
...
#define DEF_NOTIFY_BALLPOINTS					    0x0696
