...
bool DelayEvents::add(DelayEventType iDelayType, int iEffectType, uint32_t dwLastTime, int iTargetH, char cTargetType, MapPtr map, int dX, int dY, int iV1, int iV2, int iV3) {
	DelayEvent ev;
